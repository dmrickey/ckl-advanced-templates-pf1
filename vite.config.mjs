...
// ATTENTION!
// You must change `base` and the `proxy` strings replacing `/modules/ckl-advanced-templates-pf1/` with your
// module or system ID.
...
export default () => {
    ...
    return {
        ...
        base: '/modules/ckl-advanced-templates-pf1/',    // Base module path that 30001 / served dev directory.
        ...
        server: {
            ...
            open: '/game',
            proxy: {
                '^(/modules/ckl-advanced-templates-pf1/lang)': 'http://localhost:30000',
                '^(?!/modules/ckl-advanced-templates-pf1/)': 'http://localhost:30000',
